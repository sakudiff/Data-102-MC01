...
The notebook has placeholder cells for:
- **§6 Data Modelling**: Multiple linear regression with tuition × sector interaction, log-transformed variables, robustness checks
- **§7 Insights and Conclusions**: Synthesis of Phase 1 + Phase 2 into policy-relevant findings
